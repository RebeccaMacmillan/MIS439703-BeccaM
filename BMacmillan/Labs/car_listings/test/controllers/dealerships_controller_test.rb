...
class DealershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealership" do
    assert_difference('Dealership.count') do
      post dealerships_url, params: { dealership: { location_address: @dealership.location_address, location_city: @dealership.location_city, location_state: @dealership.location_state, location_zip: @dealership.location_zip, name: @dealership.name, owner: @dealership.owner } }
    end
  ...
  test "should update dealership" do
    patch dealership_url(@dealership), params: { dealership: { location_address: @dealership.location_address, location_city: @dealership.location_city, location_state: @dealership.location_state, location_zip: @dealership.location_zip, name: @dealership.name, owner: @dealership.owner } }
